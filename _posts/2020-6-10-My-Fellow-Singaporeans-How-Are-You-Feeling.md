---
layout: post
title: My Fellow Singaporeans How Are You Feeling?
categories:
- Data Science
---

![video]({{ site.baseurl }}/images/mfsImages/Picture1.png)
...
As I could not find any dataset on youtube comments, I used a tweet dataset that I got from kaggle with both sentiment and emotion labels. Then I used a pretrained DistilBert model to train the data. You can see the training code [here](https://www.kaggle.com/garyongguanjie/comments-analysis/).
...
![sentiment_image]({{ site.baseurl }}/images/mfsImages/sentiment.png)

![emotion_image]({{ site.baseurl }}/images/mfsImages/emotion.png)
...
![sentiment_image]({{ site.baseurl }}/images/mfsImages/sentiment1.png)

![emotion_image]({{ site.baseurl }}/images/mfsImages/emotion1.png)
